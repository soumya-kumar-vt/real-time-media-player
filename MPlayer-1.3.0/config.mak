...
CXXFLAGS = -Wundef -Wall -Wno-switch -Wno-parentheses -Wpointer-arith -Wredundant-decls -Werror=format-security  -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -D_ISOC99_SOURCE -I. -Iffmpeg -O4 -march=native -mtune=native -pipe -ffast-math -fomit-frame-pointer -fno-tree-vectorize -fno-asynchronous-unwind-tables -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE -D__STDC_CONSTANT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_LIMIT_MACROS  -fpie -DPIC -D_REENTRANT  -DZLIB_CONST 
CC_DEPFLAGS = -MMD -MP
...
CONFIG_STATIC = yes
SRC_PATH      = .
DST_PATH      = /home/sajan/chronos/ChronOS-4.16/MPlayer-1.3.0/ffmpeg
LIBPREF       = lib
LIBSUF        = .a
